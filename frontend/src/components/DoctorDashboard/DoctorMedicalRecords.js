...
const MedicalRecords = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/api/employee/assigned-patients/${doctorId}`)
        ...
        <div className="medical-records">
          ...
          <div className="section">
            <button onClick={() => toggleSection('patientInfo')}>
              {collapsedSections.patientInfo ? '' : ''} Patient Information
            </button>
          ...
          <div className="section">
            <button onClick={() => toggleSection('allergies')}>
              {collapsedSections.allergies ? '' : ''} Allergies
            </button>
        ...
        <table>
          ...
          <div className="section">
            <button onClick={() => toggleSection('immunizations')}>
              {collapsedSections.immunizations ? '' : ''} Immunizations
            </button>
          ...
          <div className="section">
            <button onClick={() => toggleSection('prescriptions')}>
              {collapsedSections.prescriptions ? '' : ''} Prescriptions
            </button>
          ...
          <div className="section">
            <button onClick={() => toggleSection('diagnostics')}>
              {collapsedSections.diagnostics ? '' : ''} Diagnostics
            </button>
